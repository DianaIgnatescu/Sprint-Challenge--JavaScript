...
zooAnimals.forEach((animal) => {
  animalNames.push(`NameL ${animal.animal_name}, Scientific: ${animal.scientific_name}`);
});
...
*/
const populationTotal = zooAnimals.reduce((total, population) => total + population.population, 0);
